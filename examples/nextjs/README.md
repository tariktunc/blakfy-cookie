...
- The widget itself loads from jsDelivr (`cdn.jsdelivr.net/npm/@blakfy/cookie@2.1.1/dist/cookie.min.js`) at runtime via `next/script`. No bundling of the vanilla script needed. Or install via npm: `npm i @blakfy/cookie @blakfy/cookie-next`.
