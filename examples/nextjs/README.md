...
- The widget itself loads from jsDelivr (`cdn.jsdelivr.net/gh/tariktunc/blakfy-cookie@2/dist/cookie.min.js`) at runtime via `next/script`. No bundling of the vanilla script needed.
