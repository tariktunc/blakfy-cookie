// blakfy-cookie/src/i18n/translations/ru.js — Russian translations

export default {
  title: "Настройки файлов cookie",
  intro:
    "Этот сайт использует файлы cookie для улучшения вашего опыта. Подробности в Политике использования cookie.",
  ...
  cat: {
    ...
    recording: {
      title: "Запись сеанса",
      desc: "Записывает или воспроизводит ваш сеанс (тепловые карты, запись экрана) для анализа UX.",
    },
  },
  placeholder: {
