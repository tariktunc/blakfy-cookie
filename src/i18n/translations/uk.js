// blakfy-cookie/src/i18n/translations/uk.js — Ukrainian translations

export default {
  title: "Налаштування файлів cookie",
  intro:
    "Цей сайт використовує файли cookie для покращення вашого досвіду. Дивіться нашу Політику cookie.",
  ...
  cat: {
    ...
    recording: {
      title: "Запис сеансу",
      desc: "Записує або відтворює ваш сеанс (теплові карти, запис екрана) для аналізу UX.",
    },
  },
  placeholder: {
