// blakfy-cookie/src/i18n/translations/it.js — Italian translations

export default {
  title: "Preferenze Cookie",
  intro:
    "Questo sito usa i cookie per migliorare la tua esperienza. Consulta la nostra Informativa sui Cookie.",
  ...
  cat: {
    ...
    marketing: {
      ...
      desc: "Usati per pubblicità personalizzata e retargeting.",
    },
    functional: {
    ...
    recording: {
      title: "Registrazione sessione",
      desc: "Registra o riproduce la tua sessione (mappe di calore, registrazione schermo) per analisi UX.",
    },
  },
  placeholder: {
  ...
  cookiePanel: {
    caveat:
      "Questo elenco mostra i cookie leggibili da questa pagina (document.cookie). Non può vedere i cookie HttpOnly e non fornisce informazioni su localStorage, IndexedDB o fingerprinting — è una visualizzazione parziale, non un inventario completo.",
    empty: "Nessun cookie rilevato su questa pagina.",
    unrecognised: "Non riconosciuto — non corrisponde a nessun servizio noto",
    essential: "Essenziale — non può essere eliminato",
    delete: "Elimina",
  },
};
