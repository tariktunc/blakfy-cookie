// blakfy-cookie/src/i18n/translations/id.js — Indonesian translations

export default {
  title: "Preferensi Cookie",
  intro:
    "Situs ini menggunakan cookie untuk meningkatkan pengalaman Anda. Lihat Kebijakan Cookie kami.",
